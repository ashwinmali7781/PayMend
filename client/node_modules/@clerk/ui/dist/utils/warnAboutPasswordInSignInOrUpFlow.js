...
//#region src/utils/warnAboutPasswordInSignInOrUpFlow.ts
function formatPasswordInSignInOrUpWarning() {
	return [
...
*/
function warnAboutPasswordInSignInOrUpFlow({ signUpIfMissingEnabled, passwordEnabled }) {
	if (!signUpIfMissingEnabled || !passwordEnabled) return;
	logger.warnOnce(formatPasswordInSignInOrUpWarning());
}

//#endregion
export { warnAboutPasswordInSignInOrUpFlow };
//# sourceMappingURL=warnAboutPasswordInSignInOrUpFlow.js.map