...
import { BlankCaptchaModal, CreateOrganizationModal, EnableOrganizationsPrompt, ImpersonationFab, InviteMembersModal, KeylessPrompt, OrganizationProfileModal, SignInModal, SignUpModal, UserProfileModal, UserVerificationModal, WaitlistModal, preloadComponent } from "./lazyModules/components.js";
...
const Components = (props) => {
	...
	const { googleOneTapModal, signInModal, signUpModal, userProfileModal, userVerificationModal, organizationProfileModal, inviteMembersModal, createOrganizationModal, waitlistModal, blankCaptchaModal, checkoutDrawer, planDetailsDrawer, subscriptionDetailsDrawer } = state;
	...
	const mountedInviteMembersModal = /* @__PURE__ */ jsx(LazyModalRenderer, {
		globalAppearance: state.appearance,
		appearanceKey: "organizationProfile",
		...
		modalContainerSx: { alignItems: "center" },
		children: /* @__PURE__ */ jsx(InviteMembersModal, { ...inviteMembersModal })
	});
