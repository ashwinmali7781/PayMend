...
//#region src/components/OAuthConsent/ListGroup.tsx
function ListGroup({ children, sx, ...props }) {
...
function ListGroupHeader({ children, sx, ...props }) {
	return /* @__PURE__ */ jsx(Box, {
		...props,
		sx: [(t) => ({
			padding: t.space.$3,
...
function ListGroupHeaderTitle(props) {
...
function ListGroupContent({ children, sx, ...props }) {
	return /* @__PURE__ */ jsx(Box, {
		...props,
		as: "ul",
		sx: [(t) => ({
...
function ListGroupItem({ children, sx, ...props }) {
	return /* @__PURE__ */ jsx(Box, {
		...props,
		as: "li",
		sx: [(t) => ({
...
function ListGroupItemLabel(props) {
	return /* @__PURE__ */ jsx(Text, {
		...props,
		variant: "subtitle",
...
//#endregion
export { ListGroup, ListGroupContent, ListGroupHeader, ListGroupHeaderTitle, ListGroupItem, ListGroupItemLabel };
