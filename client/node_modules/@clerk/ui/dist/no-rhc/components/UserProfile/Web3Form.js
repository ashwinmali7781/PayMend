...
const AddWeb3WalletActionMenu = () => {
	...
	const connect = async ({ strategy, walletName }) => {
		...
		try {
			...
			if (!identifier) throw new ClerkRuntimeError("A Web3 Wallet extension cannot be found. Please install one to continue.", { code: "web3_missing_identifier" });
