...
import { warnAboutPasswordInSignInOrUpFlow } from "../../utils/warnAboutPasswordInSignInOrUpFlow.js";
...
const useSignInContext = () => {
	...
	const signUpIfMissingEnabled = isCombinedFlow && Boolean(userSettings.attackProtection?.enumeration_protection?.enabled) && signUpMode === SIGN_UP_MODES.PUBLIC;
	if (clerk.instanceType === "development") warnAboutPasswordInSignInOrUpFlow({
